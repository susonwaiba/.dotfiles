...
mytextclock = wibox.widget.textclock("   %a %Y-%m-%d %l:%M %P ", 30)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "Print",
        function() awful.util.spawn("flameshot gui --clipboard --pin --path /home/suson/Pictures/Screenshots/") end,
        { description = "open screenshot" }),
    awful.key({ modkey, "Shift" }, "Print",
        function() awful.util.spawn("flameshot screen --clipboard --pin --path /home/suson/Pictures/Screenshots/") end,
        { description = "open screenshot" }),
    ...
    awful.key({ modkey, "Shift" }, "-",
        function() awful.util.spawn("i3lock -i /home/suson/.my-background/background-dark.png -t") end,
        { description = "open lock screen" }),
    ...
    awful.key({ modkey }, "d", function() awful.util.spawn("dmenu_run") end,
        { description = "run denu", group = "launcher" }),
...
awful.rules.rules = {
    ...
    { rule = { class = "Teams" },                   properties = { screen = 1, tag = "9" } },
}
-- }}}
...
-- Autostart
awful.spawn.with_shell("/home/suson/.config/awesome/autorun.sh");
